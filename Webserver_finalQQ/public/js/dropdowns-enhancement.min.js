(function(e) {
    function n(b) { e(b).on("click" + p, this.toggle) }
    ...
    h.change = function(b) {
        ...
        b && b.length && !1 !== b.data("placeholder") &&
            (void 0 == b.data("placeholder") && b.data("placeholder", e.trim(b.text())), c = e.data(b[0], "placeholder"), a = a.find("li > input:checked"), a.length && (c = [], a.each(function() {
                ...
                (a = a.html()) && c.push(e.trim(a)) }), c = 1 > c.length ? c.join(", ") : c.length + " selected"), a = b.find(".caret"), b.html(c || "&nbsp;"), a.length && b.append(" ") && a.appendTo(b))
    };
    var t = e.fn.dropdown;
    ...
    e.fn.dropdown.clearMenus = function(b) { e(l).remove();
